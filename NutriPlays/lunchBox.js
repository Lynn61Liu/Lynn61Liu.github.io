...
const closeDangerBtn = document.getElementById('closeDangerDiv');
    ...
    if (classes.contains("veg")) {
      ...
      // click the dunut and add show class for 
      // alert(
  ...
  const closeDangerBtn = document.getElementById('closeDangerDiv');
  closeDangerBtn.addEventListener('click', function () {
